...
import com.empvsn.foursquareexample.R;
...
public class ActivityFoursquare extends ListActivity {
	ArrayList<FoursquareVenue> venuesList;
	//put your CLIENT ID AND ACLIENT SECRETE
	final String CLIENT_ID = "";
	final String CLIENT_SECRET = "";
	// we will need to take the latitude and the logntitude from a certain point
	// this is the center of Baner Pune
	...
	private class fourquare extends AsyncTask<View, Void, String> {
		...
		protected String doInBackground(View... urls) {
			...
			temp = makeCall("https://api.foursquare.com/v2/venues/search?client_id="
					...
					+ "&client_secret="
					+ CLIENT_SECRET
					+ "&v=20130815&ll=18.5615379,73.785761");
			return "";
		}
		...
		protected void onPostExecute(String result) {
			if (temp == null) {
				...
				// set the results to the listView
				
				myAdapter = new ArrayAdapter<String>(ActivityFoursquare.this,
